...
Use `$problem-map` to map a tool that helps small teams keep decisions from getting lost after design meetings.

## Expected Flow

1. Problem Map asks what breaks today, who feels it, why now, and how teams solve it today.
